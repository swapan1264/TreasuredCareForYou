    ...
    <>
      ...
      <section className="bg-white-50 lg:mx-auto">
        <div className="max-w-6xl mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-5xl font-extrabold text-center my-16 text-pink font-heading">Our Vision &amp; Mission</h2>
          <div className="flex flex-col md:flex-row gap-8">
            {/* Vision Card */}
            <div className="flex-1 bg-pink text-white rounded-xl shadow-lg p-6">
              <h3 className="text-2xl font-bold mb-4 text-primary-600 font-heading">Our Vision</h3>
              <p className="text-white-700 leading-relaxed text-left font-heading">
            ...
            {/* Mission Card */}
            <div className="flex-1 bg-pink text-white rounded-xl shadow-lg p-6">
              <h3 className="text-2xl font-bold mb-4 text-primary-600 font-heading">Our Mission</h3>
              <p className="text-white-700 leading-relaxed text-left font-heading">
